    ...
    <div className="space-y-12 sm:space-y-16">
      <section className="text-center py-12 sm:py-16">
        ...
        <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed px-4">
          A place where I share my thoughts on web development, programming, and
          technology. Join me on this journey of continuous learning and growth.
        </p>
      </section>
      ...
      <section>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 sm:mb-10 space-y-4 sm:space-y-0">
          ...
          >
            View all posts
            <span className="inline-block ml-1 group-hover:translate-x-1 transition-transform duration-200">
              →
            </span>
          </Link>
        </div>
